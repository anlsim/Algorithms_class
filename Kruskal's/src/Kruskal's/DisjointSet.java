...
/**
 *
 * The following code is an excerpt from "Data Structures and Algorithms
 * Analysis in Java", third edition by Mark Allen Weiss.
 */
public class DisjointSet {
     ...
     * union
     * 
     * not one of the two smart union algorithms presented
     * in section 8.4 of the weiss text. However, path 
     * compression is used with find(). Assume that the
     * roots are distinct.
     * 
     * @param root1 the root of set 1
     * @param root2 the root of set 2
